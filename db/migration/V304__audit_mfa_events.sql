...
CREATE TABLE AUDIT_MFA_EVENTS (
    ...
    admin_id NUMBER,  -- If admin action
        ...
        BEGIN
            ...
            IF l_high <= l_cutoff THEN
                ...
                EXCEPTION WHEN OTHERS THEN
                    -- If we fail for a partition, continue; the procedure should be resilient
                    NULL;
                END;
            END IF;
        EXCEPTION WHEN OTHERS THEN
            -- If HIGH_VALUE cannot be evaluated, skip and continue
            NULL;
        END;
    END LOOP;
